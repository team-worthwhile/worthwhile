...
\lstdefinelanguage{worthwhile}
  {morekeywords={function,Boolean,Integer,_ensures,_return,return,_assert,_requires,_invariant,while},
...
\begin{frame}
	...
	\begin{columns}[c]
		...
		\begin{figure}
			\uncover<2-3>{\includegraphics[width=\textwidth]{screenshot1.png}}
		\end{figure}
	...
	\begin{columns}[c]
		...
		\begin{figure}
			\only<4>{\includegraphics[width=2.5cm]{z3.png}}
			\only<5>{\includegraphics[width=\textwidth]{screenshot2.png}}
		\end{figure}
	\end{columns}
