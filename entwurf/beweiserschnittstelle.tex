...
Bereitet \type{AST::Program}s bzw.\ \type{AST::Annotation}s entsprechend der
Worthwhile-""Syntax und -""Semantik vor, lässt sie von einem
\type{ProgramTransformer::FormulaGenerator} in eine \type{AST::Expression} überführen und diese
von einem \type{TheoremProver::ProverCaller} auf Validität überprüfen. Das an den
...
\begin{description}%
    ...
    \attr{private transformer : ProgramTransformer::FormulaGenerator}%

    \attr{private checkResult : TheoremProver::ProverResult}%
...
\begin{description}%
    ...
    \method{public SpecificationChecker(transformer : ProgramTransformer::FormulaGenerator)}%

    \method{public checkProgram(program : AST::Program) : Validity}
    ...
    \method{public checkAnnotation(annotation : AST::Annotation, environment : StringToValueMap) : Validity}
    ...
    %\method{public getCheckResult() : TheoremProver::ProverResult}
    %
...
\subsubsection{class SMTLIBStrategy implements AST::ASTNodeVisitor, FormulaCompiler}%
...
\subsubsection{abstract class StdProver extends ProverCaller}%
...
\subsubsection{class Z3Prover extends StdProver}%
...
\subsubsection{class WPStrategy implements AST::ASTNodeVisitor, FormulaGenerator}%
