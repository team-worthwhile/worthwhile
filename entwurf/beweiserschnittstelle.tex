...
Bereitet \type{Program}s bzw.\ \type{Annotation}s entsprechend der
Worthwhile-""Syntax und -""Semantik vor, lässt sie von einem
\type{FormulaGenerator} in eine \type{Expression} überführen und diese
von einem \type{ProverCaller} auf Validität überprüfen. Das an den
...
\subsubsection{class WPStrategy implements ASTNodeVisitor, FormulaGenerator}%
