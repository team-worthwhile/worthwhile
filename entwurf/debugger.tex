...
Dieser Teil des Debuggers implementiert des Debug-Modell von Eclipse. Somit können alle in Eclipse vorhandenen Debug-Ansichten (etwa Breakpoint-Manager, Variablenansicht, Ausdrucksansicht) mit dem Worthwhile-Interpreter kommunizieren.
