...
\begin{description}
    ...
    \method{public Map<String, Value> getAllSymbols()} gibt die im aktuellen Ausführungskontext gültige Symboltabelle zurück. Symbole werden durch einen String identifiziert und ihr Wert durch die Klasse \textt{Value} gekapselt.
\end{description}
