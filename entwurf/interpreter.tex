...
Diese Klasse erweitert \type{LineBreakpoint} um die Möglichkeit, eine \type{Expression} als Bedingung zu übergeben. Wird der Breakpoint erreicht, so wird zunächst diese Bedingung überprüft und nur bei Erfüllung ein Ereignis ausgelöst.
