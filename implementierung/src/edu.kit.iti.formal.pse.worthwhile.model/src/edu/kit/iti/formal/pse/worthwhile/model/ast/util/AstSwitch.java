...
public class AstSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AstPackage.PROGRAM: {
				...
				if (result == null) result = caseASTNode(program);
			...
			case AstPackage.AST_NODE_VISITOR: {
				ASTNodeVisitor astNodeVisitor = (ASTNodeVisitor)theEObject;
				T result = caseASTNodeVisitor(astNodeVisitor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.ADDITION: {
				...
				if (result == null) result = caseASTNode(addition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AstPackage.ARRAY_ACCESS: {
				...
				if (result == null) result = caseUnaryExpression(arrayAccess);
			...
			case AstPackage.ARRAY_LITERAL: {
				...
				if (result == null) result = caseASTNode(arrayLiteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AstPackage.ASSERTION: {
				...
				if (result == null) result = caseAnnotation(assertion);
				if (result == null) result = caseStatement(assertion);
				if (result == null) result = caseASTNode(assertion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AstPackage.ASSUMPTION: {
				...
				if (result == null) result = caseAnnotation(assumption);
				if (result == null) result = caseStatement(assumption);
				if (result == null) result = caseASTNode(assumption);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.AXIOM: {
				...
				if (result == null) result = caseAnnotation(axiom);
				if (result == null) result = caseStatement(axiom);
				if (result == null) result = caseASTNode(axiom);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AstPackage.BOOLEAN_TYPE: {
				...
				if (result == null) result = caseASTNode(booleanType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.CONDITIONAL: {
				...
				if (result == null) result = caseASTNode(conditional);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.CONJUNCTION: {
				...
				if (result == null) result = caseASTNode(conjunction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.DISJUNCTION: {
				...
				if (result == null) result = caseASTNode(disjunction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.DIVISION: {
				...
				if (result == null) result = caseASTNode(division);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.EQUAL: {
				...
				if (result == null) result = caseASTNode(equal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.EQUIVALENCE: {
				...
				if (result == null) result = caseASTNode(equivalence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.EXISTS_QUANTIFIER: {
				...
				if (result == null) result = caseQuantifiedExpression(existsQuantifier);
				if (result == null) result = caseExpression(existsQuantifier);
				if (result == null) result = caseASTNode(existsQuantifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.QUANTIFIED_EXPRESSION: {
				...
				if (result == null) result = caseASTNode(quantifiedExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AstPackage.FOR_ALL_QUANTIFIER: {
				...
				if (result == null) result = caseQuantifiedExpression(forAllQuantifier);
				if (result == null) result = caseExpression(forAllQuantifier);
				if (result == null) result = caseASTNode(forAllQuantifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AstPackage.FUNCTION_DECLARATION: {
				...
				if (result == null) result = caseASTNode(functionDeclaration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.PRECONDITION: {
				...
				if (result == null) result = caseStatement(precondition);
				if (result == null) result = caseASTNode(precondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.POSTCONDITION: {
				...
				if (result == null) result = caseAnnotation(postcondition);
				if (result == null) result = caseStatement(postcondition);
				if (result == null) result = caseASTNode(postcondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.GREATER: {
				...
				if (result == null) result = caseASTNode(greater);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.GREATER_OR_EQUAL: {
				...
				if (result == null) result = caseASTNode(greaterOrEqual);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.IMPLICATION: {
				...
				if (result == null) result = caseASTNode(implication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.INTEGER_LITERAL: {
				...
				if (result == null) result = caseASTNode(integerLiteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.INTEGER_TYPE: {
				...
				if (result == null) result = caseASTNode(integerType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.INVARIANT: {
				...
				if (result == null) result = caseAnnotation(invariant);
				if (result == null) result = caseStatement(invariant);
				if (result == null) result = caseASTNode(invariant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.LESS: {
				...
				if (result == null) result = caseASTNode(less);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.LESS_OR_EQUAL: {
				...
				if (result == null) result = caseASTNode(lessOrEqual);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.LOOP: {
				...
				if (result == null) result = caseASTNode(loop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.MINUS: {
				...
				if (result == null) result = caseSign(minus);
				if (result == null) result = caseUnaryExpression(minus);
				if (result == null) result = caseExpression(minus);
				if (result == null) result = caseASTNode(minus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.SIGN: {
				...
				if (result == null) result = caseUnaryExpression(sign);
				if (result == null) result = caseExpression(sign);
				if (result == null) result = caseASTNode(sign);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.MODULUS: {
				...
				if (result == null) result = caseBinaryExpression(modulus);
				if (result == null) result = caseExpression(modulus);
				if (result == null) result = caseASTNode(modulus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.MULTIPLICATION: {
				...
				if (result == null) result = caseASTNode(multiplication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.NEGATION: {
				...
				if (result == null) result = caseUnaryExpression(negation);
				if (result == null) result = caseExpression(negation);
				if (result == null) result = caseASTNode(negation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.PLUS: {
				...
				if (result == null) result = caseSign(plus);
				if (result == null) result = caseUnaryExpression(plus);
				if (result == null) result = caseExpression(plus);
				if (result == null) result = caseASTNode(plus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AstPackage.SUBTRACTION: {
				...
				if (result == null) result = caseASTNode(subtraction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.UNEQUAL: {
				...
				if (result == null) result = caseBinaryExpression(unequal);
				if (result == null) result = caseExpression(unequal);
				if (result == null) result = caseASTNode(unequal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AstPackage.VARIABLE_REFERENCE: {
				...
				if (result == null) result = caseASTNode(variableReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AST Node Visitor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>AST Node Visitor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseASTNodeVisitor(ASTNodeVisitor object) {
		return null;
	}
