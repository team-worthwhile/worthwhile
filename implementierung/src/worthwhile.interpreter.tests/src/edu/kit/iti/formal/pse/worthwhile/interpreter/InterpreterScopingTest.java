...
public class InterpreterScopingTest {
	...
	public void testWhileScopingWithInteger() {
		this.setInterpreter("Integer a := 42" + "\nInteger i := 0"
				+ "\nwhile(i < 10) {" + "\ni := i + 1" + "\nInteger a := 12"
				+ "\na := a - 1" + "\n}" + "\n");
		this.interpreter.execute();
		this.assertVariableEqualsValue("a", new IntegerValue(new BigInteger(
				"42")));
		this.assertVariableEqualsValue("i", new IntegerValue(new BigInteger(
				"10")));
	}

	@Test
	public void testWhileScopingWithBoolean() {
		this.setInterpreter("Boolean a := true" + "\nInteger i := 0"
				+ "\nwhile(i < 10) {" + "\ni := i + 1" + "\nInteger a := 12"
				+ "\na := a - 1" + "\n}" + "\n");
		this.interpreter.execute();
	...
	public void testWhileScopingWithIntegerArray() {
		this.setInterpreter("Integer[] a := {42, 12, 100, 1}"
				+ "\nInteger i := 0" + "\nwhile(i < 10) {" + "\ni := i + 1"
				+ "\na[1] := 4" + "\n}" + "\n");
		...
		this.interpreter.execute();
		this.assertVariableEqualsValue("a", new CompositeValue<IntegerValue>(
				array));
		this.assertVariableEqualsValue("i", new IntegerValue(new BigInteger(
				"10")));
	}
	...
	public void testWhileScopingWithBooleanArray() {
		this.setInterpreter("Boolean[] a := {true, false, false, true}"
				+ "\nInteger i := 0" + "\nwhile(i < 10) {" + "\ni := i + 1"
				+ "\na[1] := true" + "\n}" + "\n");
		...
		this.interpreter.execute();
		this.assertVariableEqualsValue("a", new CompositeValue<BooleanValue>(
				array));
		this.assertVariableEqualsValue("i", new IntegerValue(new BigInteger(
				"10")));
	}
	...
	public void testIfScopingWithIntegerArray() {
		this.setInterpreter("Boolean[] a := {42, 12, 100, 1}"
				+ "\nInteger i := 0" + "\nif(i < 10) {" + "\ni := 10"
				+ "\na[1] := true" + "\n}" + "\n");
		IntegerValue[] array = new IntegerValue[4];
		array[0] = new IntegerValue(new BigInteger("42"));
	...
	public void testFunctionScopingWithBoolean() {
		this.setInterpreter("function Boolean test() {" + "\nBoolean a := 23"
				+ "\nreturn a" + "\n}" + "\nBoolean a := 42"
				+ "\nBoolean b := test()" + "\n");
		this.interpreter.execute();
		this.assertVariableEqualsValue("a", new BooleanValue(true));
	...
	public void testFunctionScopingWithIntegerArray() {
		...
		this.assertVariableEqualsValue("a", new CompositeValue<IntegerValue>(
				array1));
		this.assertVariableEqualsValue("b", new CompositeValue<IntegerValue>(
				array2));
	}
	...
	public void testFunctionScopingWithBooleanArray() {
		...
		this.assertVariableEqualsValue("a", new CompositeValue<BooleanValue>(
				array1));
		this.assertVariableEqualsValue("b", new CompositeValue<BooleanValue>(
				array2));
	}
}
