...
public class InterpreterScopingTest {
	...
	public void assertLocalVariablesHaveExpectedValues() {
		assertTrue(this.interpreter.getSymbol("localUsedBool").equals(new BooleanValue(true)));
		assertTrue(this.interpreter.getSymbol("localUsedInt").equals(new IntegerValue(new BigInteger("42"))));
	...
	public void assertGlobalVariablesHaveExpectedValues() {
		assertTrue(this.interpreter.getSymbol("globalUsedBool").equals(new BooleanValue(false)));
		assertTrue(this.interpreter.getSymbol("globalUsedInt").equals(new IntegerValue(new BigInteger("123"))));
