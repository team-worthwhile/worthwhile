...
public abstract class AbstractExecutionEventListener {
	 ...
	 */
	public void executionFailed(final Statement statement,
	 ...
	 *            an {@link InterpreterError} object that describes the error
	 */
	public void expressionFailed(final Expression expression,
			final InterpreterError error) {
		throw new RuntimeException("Failed to execute " + expression.toString()
				+ "; Got error " + error.toString());
	}
}