...
public class Value {
	 ...
	 * @param integerValue the value for this Value.
	 */
	 ...
	 * @param booleanValue the value for this Value.
	 */
	 ...
	 * @param integerArray the value for this array.
	 */
	 ...
	 * @param booleanArray the value for this array.
	 */
	 ...
	 * @param valueType the type of this Value.
	 */
	...
	/**
	 * This sets the integer value of this Value.
	 * Note, that by calling this function, the type of this Value will be set to {@link ValueType.INTEGER_TYPE}.
	 * @param integerValue the integer value to be set.
	 */
	...
	/**
	 * This sets the boolean value of this Value.
	 * Note, that by calling this function, the type of this Value will be set to {@link ValueType.BOOLEAN_TYPE}.
	 * @param booleanValue the boolean value to be set.
	 */
	...
	/**
	 * This sets the integer array of this Value.
	 * Note, that by calling this function, the type of this Value will be set to {@link ValueType.INTEGER_ARRAY_TYPE}.
	 * @param integerArray the integer array to be set.
	 */
	...
	/**
	 * This sets the boolean array of this Value.
	 * Note, that by calling this function, the type of this Value will be set to {@link ValueType.BOOLEAN_ARRAY_TYPE}.
	 * @param booleanArray the boolean array to be set.
	 */
