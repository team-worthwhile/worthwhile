 ...
 * <ul>
 *   <li>{@link edu.kit.iti.formal.pse.worthwhile.model.ast.SymbolReference#getIndex <em>Index</em>}</li>
 * </ul>
 * </p>
 *
...
public class SymbolReference extends Expression {
	 ...
	 * @see edu.kit.iti.formal.pse.worthwhile.model.ast.AstPackage#getSymbolReference_Index()
	...
	public NotificationChain basicSetIndex(Expression newIndex, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
			                AstPackage.SYMBOL_REFERENCE__INDEX, oldIndex, newIndex);
			if (msgs == null)
				msgs = notification;
			else
	...
	/**
	 * Sets the value of the '{@link edu.kit.iti.formal.pse.worthwhile.model.ast.SymbolReference#getIndex <em>Index</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
		...
		if (newIndex != index) {
			...
			if (index != null)
				msgs = ((InternalEObject) index).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
				                - AstPackage.SYMBOL_REFERENCE__INDEX, null, msgs);
			if (newIndex != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.SYMBOL_REFERENCE__INDEX,
			                newIndex, newIndex));
	}
