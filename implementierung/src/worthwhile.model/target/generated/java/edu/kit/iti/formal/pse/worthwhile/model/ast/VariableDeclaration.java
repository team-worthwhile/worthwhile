...
public class VariableDeclaration extends Statement {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Initial Value</em>' containment reference isn't clear, there really should be more
	...
	public NotificationChain basicSetInitialValue(Expression newInitialValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
			                AstPackage.VARIABLE_DECLARATION__INITIAL_VALUE, oldInitialValue,
			                newInitialValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newInitialValue != initialValue) {
			...
			if (initialValue != null)
				msgs = ((InternalEObject) initialValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
				                - AstPackage.VARIABLE_DECLARATION__INITIAL_VALUE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
			                AstPackage.VARIABLE_DECLARATION__INITIAL_VALUE, newInitialValue,
			                newInitialValue));
	}
