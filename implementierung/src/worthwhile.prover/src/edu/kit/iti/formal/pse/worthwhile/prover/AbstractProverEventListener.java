 ...
 *
 */
public abstract class AbstractProverEventListener {
	/**
	 * Signals that all verifiable elements in a program were verified.
	 * @param program the program that has been verified
	 * @param validity the validity of the program
	 * @param proverResult the result returned by the prover
	 */
