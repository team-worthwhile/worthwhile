...
\begin{description}
    ...
    \glossaritem{Run-time-checker} Eine Komponente der Laufzeitumgebung, der zur Laufzeit das Zutreffen der Zusicherungen auf den Programmzustand überprüft und eventuelle Fehler meldet.
    ...
    \glossaritem{SMTLIB2~(Satisfiability Modulo Theories Library)} Format zur Spezifikation von prädikatenlogischen Formeln zwecks Überprüfung auf Erfüllbarkeit, erstellt von der gleichnamigen Initiative.
