...
\begin{itemize}
	    ...
	    \item
	    \begin{reqlist}{FR}%  
       \req{030}{Prüfung von quantifizierten Formeln über eingeschränktem Bereich}{Formeln über eingeschränktem Definitionsbereich kann der Run-time-""Checker ebenfalls selbst überprüfen.}%
       \end{reqlist}%
       
       \item
       \begin{reqlist}{FR}%  
    	\req{030}{Prüfung von quantifizierten Formeln über uneingeschränktem Bereich}{Wenn Formeln über uneingeschränktem Definitionsbereich ausgewertet werden, werden diese dem Beweiser zusammen mit der Programmspezifikation und dem -zustand übergeben.}%
	\end{reqlist}%
\end{itemize}
...
Die GUI stellt einen Editor f\"{u}r die spezifizierte \see{WHILE-""Sprache} zur Verf\"{u}gung. Folgende Funktionen unterst\"{u}tzen den Benutzer bei der Eingabe des Programmcodes:
	...
	\begin{reqlist}{FG}
		...
		\req{020}{Fehlerkorrektur bei der Eingabe}{Parserfehler werden direkt nach der Eingabe an der zugehörigen Position im Editor markiert.}
