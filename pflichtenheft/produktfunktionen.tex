...
\begin{reqlist}{FW}
	...
	\req{020}{Bedingte Anweisungen}{Die Sprache unterstützt eine bedingte Anweisung (\glqq{}if\grqq{}), mit der ein Codeabschnitt nur bei erfüllter Bedingung ausgeführt wird.}
...
\begin{reqlist}{FG}
    ...
    \req{040}{Unicode-Unterst\"{u}tzung}{Die Verwendung von Unicode-Symbolen f"{u}r logische Operatoren und Quantoren wird unterst"{u}tzt. Dabei soll die Eingabe solcher Symbole durch die grafische Benutzeroberfl"ache erleichtert werden.}
    \req{050}{Breakpoints}{Setzen und L\"{o}schen von Breakpoints durch Klick auf die Randspalte im Editor}
    \req{060}{Breakpoint-\"{U}bersicht}{Auflistung aller gesetzten Breakpoints in einem separaten Fenster mit der M\"{o}glichkeit, diese dort zu l\"{o}schen.}
    \req{070}{Fehler\"{u}bersicht}{In einem separaten Fenster wird eine \"{U}bersicht aller Syntaxfehler mit einer Fehlerbeschreibung angezeigt. Aus dieser Liste kann der Benutzer den Editor an der Fehlerposition aufrufen.}
    \req{080}{Programmausf"uhrung}{Der Benutzer kann den Interpreter aus der GUI heraus starten, wobei die Wahl zwischen dem Debug- und dem Ausf\"{u}hrungsmodus besteht.}
\end{reqlist}
