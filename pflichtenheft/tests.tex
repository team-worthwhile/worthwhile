...
\begin{reqlist}{T}
	...
	\req{03}{Syntaxhervorhebung im Editor}{
		...
		{Die Entwicklungsumgebung ist gestartet.}
		{\begin{enumerate}
	...
	\req{04}{Debuggen eines Programms}{
		...
		{Die Entwicklungsumgebung ist gestartet und es ist ein Programm geladen, das der Sprachspezifikation entspricht und alle definierten Sprachkonstrukte mindestens einmal enthält.}
		{\begin{enumerate}
			\item Mittels des entsprechenden Befehls in der Entwicklungsumgebung werden ein oder mehrere Breakpoints gesetzt.
	...
	\req{05}{Ansprechbarkeit der Benutzeroberfläche}{
		...
		{Die Entwicklungsumgebung ist gestartet und es ist ein Programm geladen, das der Sprachspezifikation entspricht und eine Endlosschleife enthält.}
		{\begin{enumerate}
	...
	\req{06}{Ändern von Variablenwerten während der Ausführung eines Programms}{
		...
		{Die Entwicklungsumgebung ist gestartet und es ist ein Programm geladen, für das mehrere Breakpoints gesetzt sind.}
		{\begin{enumerate}
