...
\begin{description}%
    ...
    \item [Soll] Spezielle Syntax~("`syntactic sugar"'), um die Verst"andlichkeit von Annotationen zu verbessern und ihre Formulierung intuitiver zu gestalten:%
        ...
        \end{itemize}%
    \item [Wunsch] Es besteht die M"oglichkeit, mehrere Vor- und Nachbedingungen f"ur eine Funktion anzugeben.%
    ...
    \item [Abgrenzung] Der Bereich quantifizierter Aussagen darf kein Bereich von Funktionen sein.%
\end{description}%

\subsection{Interpreter}%

Der \see{Interpreter} führt Programme aus, welche in der für \textit{Worthwhile} definierten WHILE-Sprache verfasst sind.%
...
\begin{description}%
    ...
    \item [Wunsch] Übersetzung von Modellen, welche der Beweiser für die Nichterfülltheit einer Spezifikation liefert, in Aufrufe des spezifizierten WHILE-""Programms%
