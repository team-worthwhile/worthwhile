...
public class AbstractMyDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_DivisionOp_DivisionSignKeyword_1_1_or_SolidusKeyword_1_0.equals(syntax))
				emit_DivisionOp_DivisionSignKeyword_1_1_or_SolidusKeyword_1_0(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     '/' | '÷'
	 */
	protected void emit_DivisionOp_DivisionSignKeyword_1_1_or_SolidusKeyword_1_0(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     '·' | '*'
	 */
	protected void emit_MultiplicationOp_AsteriskKeyword_1_0_or_MiddleDotKeyword_1_1(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
