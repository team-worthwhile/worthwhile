...
\end{enumerate}}{Korrekte Auswertung der gültigen Ausdrücke, Anzeige einer Fehlermeldungen bei ungültigen oder nicht auswertbaren Ausdrücken}{(OK)}{Bug \#91: Watch expressions are not validated –  behoben \\ Bug \#113: EmptyStackException when evaluating 1/0 as expression}
